"""Build FireRedOCR image-prefill and image-decode ONNX bundles.
...
def save_shared_initializers_from_tensors(shared: dict[str, TensorProto], path: Path) -> None:
	...
	model = helper.make_model(graph, producer_name="FireRedOCR.Shared_Merged")
	model.ir_version = 10
...
def merge_models_no_check(
	...
	merged.producer_name = "FireRedOCR.Shared_Merged"
...
def _zero_like_model(
	...
	return helper.make_model(
		graph,
		producer_name="FireRedOCR.Shared_Merged",
